...
for col, data in tqdm(dataset.iterrows(), total=len(dataset), desc="Processing"):
    ...
    query = f'''Gitt konteksten nedenfor, velg det mest passende uttrykket fra de oppgitte alternativene. Svar kun med ett alternativ uten forklaringer eller annen tekst.
    ...
    try:
        ...
        output = model.generate(
            ...
            repetition_penalty=1.2,  # Slightly increase the repetition penalty
